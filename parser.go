...
// Raw returns string representation of the v.
//
// The function is for debugging purposes only. It isn't optimized for speed.
// See MarshalTo instead.
//
// Don't confuse this function with String, which must be called
...
func (v *Value) GetString(keys ...string) []byte {
	v = v.Get(keys...)
...
// String returns the underlying JSON string for the v.
//
// The returned string is valid until Parse is called on the Parser returned v.
//
// Use GetString if you don't need error handling.
func (v *Value) String() ([]byte, error) {
